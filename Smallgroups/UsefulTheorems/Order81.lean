...
/-- The three currently certified non-abelian representatives of order `81`. -/
abbrev order81_nonabelian_reps : Fin 3 → Type :=
  rep3 order81_heisenberg_prod_cyclic order81_semidirectP2P_prod_cyclic
    order81_c9c3_shear_rep

/-- Each currently certified non-abelian representative has order `81`. -/
theorem card_order81_nonabelian_reps (i : Fin 3) :
...
theorem order81_nonabelian_reps_nonabelian (i : Fin 3) :
...
/-- The three currently certified non-abelian representatives are pairwise non-isomorphic. -/
...
/-- The currently formalized eight representatives are pairwise non-isomorphic. -/
