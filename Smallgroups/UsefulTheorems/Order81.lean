...
/-- The four currently certified non-abelian representatives of order `81`. -/
abbrev order81_nonabelian_reps : Fin 4 → Type :=
  rep4 order81_heisenberg_prod_cyclic order81_semidirectP2P_prod_cyclic
    order81_c9c3_shear_rep order81_c27_semidirect_rep

/-- Each currently certified non-abelian representative has order `81`. -/
theorem card_order81_nonabelian_reps (i : Fin 4) :
...
theorem order81_nonabelian_reps_nonabelian (i : Fin 4) :
...
/-- The four currently certified non-abelian representatives are pairwise non-isomorphic. -/
...
/-- The currently formalized nine representatives are pairwise non-isomorphic. -/
