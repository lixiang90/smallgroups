...
import Smallgroups.UsefulTheorems.Order32Certificate.CocycleBasisParent06
...
theorem cocycle27_consistent : IsCentralCocycle cocycle27 := by
  have hdecode : cocycle27 = Order16Table.decodeTwo parent11Table
      (synthesizeTwo coverageP11HBasis (coeffMask 6 5)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle28_consistent : IsCentralCocycle cocycle28 := by
  have hdecode : cocycle28 = Order16Table.decodeTwo parent11Table
      (synthesizeTwo coverageP11HBasis (coeffMask 6 3)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent11Table
    coverageP11HBasis orbitP11_hbasis_cocycle _
...
theorem cocycle29_consistent : IsCentralCocycle cocycle29 := by
  have hdecode : cocycle29 = Order16Table.decodeTwo parent11Table
      (synthesizeTwo coverageP11HBasis (coeffMask 6 13)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent11Table
    coverageP11HBasis orbitP11_hbasis_cocycle _
...
theorem cocycle30_consistent : IsCentralCocycle cocycle30 := by
  have hdecode : cocycle30 = Order16Table.decodeTwo parent11Table
      (synthesizeTwo coverageP11HBasis (coeffMask 6 12)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent11Table
    coverageP11HBasis orbitP11_hbasis_cocycle _
...
theorem cocycle31_consistent : IsCentralCocycle cocycle31 := by
  have hdecode : cocycle31 = Order16Table.decodeTwo parent11Table
      (synthesizeTwo coverageP11HBasis (coeffMask 6 21)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent11Table
    coverageP11HBasis orbitP11_hbasis_cocycle _
...
theorem cocycle32_consistent : IsCentralCocycle cocycle32 := by
  have hdecode : cocycle32 = Order16Table.decodeTwo parent12Table
      (synthesizeTwo coverageP12HBasis (coeffMask 5 13)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle33_consistent : IsCentralCocycle cocycle33 := by
  have hdecode : cocycle33 = Order16Table.decodeTwo parent13Table
      (synthesizeTwo coverageP13HBasis (coeffMask 5 13)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle34_consistent : IsCentralCocycle cocycle34 := by
  have hdecode : cocycle34 = Order16Table.decodeTwo parent11Table
      (synthesizeTwo coverageP11HBasis (coeffMask 6 2)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent11Table
    coverageP11HBasis orbitP11_hbasis_cocycle _
...
theorem cocycle35_consistent : IsCentralCocycle cocycle35 := by
  have hdecode : cocycle35 = Order16Table.decodeTwo parent11Table
      (synthesizeTwo coverageP11HBasis (coeffMask 6 11)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent11Table
    coverageP11HBasis orbitP11_hbasis_cocycle _
...
theorem cocycle36_consistent : IsCentralCocycle cocycle36 := by
  have hdecode : cocycle36 = Order16Table.decodeTwo parent5Table
      (synthesizeTwo coverageP5HBasis (coeffMask 3 0)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle37_consistent : IsCentralCocycle cocycle37 := by
  have hdecode : cocycle37 = Order16Table.decodeTwo parent6Table
      (synthesizeTwo coverageP6HBasis (coeffMask 2 0)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent6Table
    coverageP6HBasis orbitP6_hbasis_cocycle _
...
theorem cocycle38_consistent : IsCentralCocycle cocycle38 := by
  have hdecode : cocycle38 = Order16Table.decodeTwo parent10Table
      (synthesizeTwo coverageP10HBasis (coeffMask 6 34)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle39_consistent : IsCentralCocycle cocycle39 := by
  have hdecode : cocycle39 = Order16Table.decodeTwo parent7Table
      (synthesizeTwo coverageP7HBasis (coeffMask 3 0)) := by decide +kernel
  rw [hdecode]
