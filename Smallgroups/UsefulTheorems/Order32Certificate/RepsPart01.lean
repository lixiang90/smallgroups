...
theorem cocycle1_consistent : IsCentralCocycle cocycle1 := by
  have hdecode : cocycle1 = Order16Table.decodeTwo parent1Table
      (synthesizeTwo coverageP1HBasis (coeffMask 1 1)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle2_consistent : IsCentralCocycle cocycle2 := by
  have hdecode : cocycle2 = Order16Table.decodeTwo parent2Table
      (synthesizeTwo coverageP2HBasis (coeffMask 3 2)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle3_consistent : IsCentralCocycle cocycle3 := by
  have hdecode : cocycle3 = Order16Table.decodeTwo parent2Table
      (synthesizeTwo coverageP2HBasis (coeffMask 3 1)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent2Table
    coverageP2HBasis orbitP2_hbasis_cocycle _
...
theorem cocycle4_consistent : IsCentralCocycle cocycle4 := by
  have hdecode : cocycle4 = Order16Table.decodeTwo parent2Table
      (synthesizeTwo coverageP2HBasis (coeffMask 3 3)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent2Table
    coverageP2HBasis orbitP2_hbasis_cocycle _
...
theorem cocycle5_consistent : IsCentralCocycle cocycle5 := by
  have hdecode : cocycle5 = Order16Table.decodeTwo parent3Table
      (synthesizeTwo coverageP3HBasis (coeffMask 4 10)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle6_consistent : IsCentralCocycle cocycle6 := by
  have hdecode : cocycle6 = Order16Table.decodeTwo parent3Table
      (synthesizeTwo coverageP3HBasis (coeffMask 4 3)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent3Table
    coverageP3HBasis orbitP3_hbasis_cocycle _
...
theorem cocycle7_consistent : IsCentralCocycle cocycle7 := by
  have hdecode : cocycle7 = Order16Table.decodeTwo parent3Table
      (synthesizeTwo coverageP3HBasis (coeffMask 4 9)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent3Table
    coverageP3HBasis orbitP3_hbasis_cocycle _
...
theorem cocycle8_consistent : IsCentralCocycle cocycle8 := by
  have hdecode : cocycle8 = Order16Table.decodeTwo parent3Table
      (synthesizeTwo coverageP3HBasis (coeffMask 4 15)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent3Table
    coverageP3HBasis orbitP3_hbasis_cocycle _
...
theorem cocycle9_consistent : IsCentralCocycle cocycle9 := by
  have hdecode : cocycle9 = Order16Table.decodeTwo parent3Table
      (synthesizeTwo coverageP3HBasis (coeffMask 4 1)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent3Table
    coverageP3HBasis orbitP3_hbasis_cocycle _
...
theorem cocycle10_consistent : IsCentralCocycle cocycle10 := by
  have hdecode : cocycle10 = Order16Table.decodeTwo parent3Table
      (synthesizeTwo coverageP3HBasis (coeffMask 4 7)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent3Table
    coverageP3HBasis orbitP3_hbasis_cocycle _
...
theorem cocycle11_consistent : IsCentralCocycle cocycle11 := by
  have hdecode : cocycle11 = Order16Table.decodeTwo parent3Table
      (synthesizeTwo coverageP3HBasis (coeffMask 4 2)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent3Table
    coverageP3HBasis orbitP3_hbasis_cocycle _
...
theorem cocycle12_consistent : IsCentralCocycle cocycle12 := by
  have hdecode : cocycle12 = Order16Table.decodeTwo parent4Table
      (synthesizeTwo coverageP4HBasis (coeffMask 3 4)) := by decide +kernel
  rw [hdecode]
...
theorem cocycle13_consistent : IsCentralCocycle cocycle13 := by
  have hdecode : cocycle13 = Order16Table.decodeTwo parent4Table
      (synthesizeTwo coverageP4HBasis (coeffMask 3 2)) := by decide +kernel
  rw [hdecode]
  exact Order16Table.isCentralCocycle_decodeTwo_synthesize parent4Table
    coverageP4HBasis orbitP4_hbasis_cocycle _
