...
$N = 4 路 19, so there are exactly **four** groups of order $N up to isomorphism:
the cyclic group 鈩?76, 鈩?2 脳 鈩?38, 鈩?19 鈰奯{-1} 鈩?4, and 鈩?2 脳 D_38.
This is the p = 19 (p 鈮?3 mod 4) instance of the order-4p classification in
...
theorem classification (h : Nat.card G = 76) :
  ...
  simpa [RA, RB, RC, RD, show (4 : 鈩? * 19 = 76 by norm_num] using
